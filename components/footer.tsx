      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
        ...
        <div className="col-span-2 space-y-4">
          <div className="flex items-center gap-3 mb-2">
            <img
              src="/footer_logo.png"
              alt="PP Maniya Trust Logo"
              className="w-14 h-14 object-contain rounded-xl bg-white p-1"
            />
            <span className="text-white font-extrabold text-sm tracking-wider uppercase leading-snug mr-20">
              {t?.fullName}
            </span>
          </div>
          {/* <span className="text-[#ffff] font-extrabold text-sm tracking-wider uppercase block">
            {t?.fullName}
          </span> */}
          <p className="text-slate-400 text-xs sm:text-sm leading-relaxed max-w-sm">
            Formed in 2019 to honor the lifelong philanthropic vision of Late
            Popatbhai Premjibhai Maniya. Actively driving educational
            scholarship schemes, clinical medicine diagnostics, and social
            welfare programs.
          </p>
          <div className="pt-2">
            ...
            <span className="block font-mono text-xs text-[#ffff] font-semibold select-all">
              Reg E/22531/SURAT
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:justify-between items-center gap-4 text-center md:text-left">
          <div>
            <span className="block">
              &copy; {new Date().getFullYear()} Late Popatbhai Premjibhai Maniya
              Trust. All Rights Reserved.
            </span>
            <span className="block text-slate-600 mt-1">
              Compiled in accordance with Section 12A, 80G and corporate CSR
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-end text-slate-400">
            <button
              onClick={() =>
                setToastMessage(
                  "Privacy Policy: Standard public data usage guidelines are fully enforced.",
                )
              }
            ...
            <button
              onClick={() =>
                setToastMessage(
                  "Terms & Conditions: Sincere giving transactions operate compliant paths.",
                )
              }
              className="hover:text-white transition"
            >
            ...
            <button
              onClick={() =>
                setToastMessage(
                  "Refund Policy: Philanthropic grants can be requested within 15 working days.",
                )
              }
            ...
            <button
              onClick={() =>
                setToastMessage(
                  "Disclaimer: The trust operates purely as a certified non-profit state NGO.",
                )
              }
              className="hover:text-white transition"
            >
