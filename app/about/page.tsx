      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6 bg-slate-50 p-8 rounded-3xl border border-slate-100 shadow-inner mb-16">
            <div>
              <span className="block text-xs uppercase tracking-wider text-[#64748B] font-semibold mb-1">
                Registered Entity
              </span>
              <span className="block text-slate-950 font-bold text-sm sm:text-base leading-tight">
            ...
            <div className="border-t md:border-t-0 md:border-l border-slate-200 pt-4 md:pt-0 md:pl-6">
              ...
              <span className="block text-slate-600 font-bold text-xs sm:text-sm leading-relaxed select-all">
                {t?.address}
              </span>
            </div>
            <div className="border-t md:border-t-0 md:border-l border-slate-200 pt-4 md:pt-0 md:pl-6">
              ...
              <span className="block text-slate-950 font-bold text-sm sm:text-base">
                2019 (Surat Registry)
              </span>
            </div>
            <div className="border-t md:border-t-0 md:border-l border-slate-200 pt-4 md:pt-0 md:pl-6">
          ...
          <div className="mb-16">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-6 gap-4">
              {[
                ...
                <div
                  key={idx}
                  className={`p-4 rounded-xl bg-slate-50 border border-slate-100 border-t-4 text-center ${val.border}`}
                >
          ...
          <div className="bg-slate-50 p-8 sm:p-12 rounded-3xl border border-slate-100">
            <h2 className="text-2xl font-bold text-slate-950 mb-10 text-center">
            ...
            <div className="relative max-w-3xl mx-auto pl-6 sm:pl-0">
              ...
              {[
                ...
                {
                  year: "2024",
                  title: "Specialist Medical Camps Expansion",
                ...
                <div
                  key={index}
                  className={`relative sm:flex items-center justify-between mb-8 sm:mb-12 ${index % 2 === 0 ? "sm:flex-row-reverse" : ""}`}
                >
